...
int main(int argc, char **argv) {
  ...
  std::vector<cv::String> fnImg;
  std::vector<cv::String> fnPcd;
  ROS_WARN("Before reading");
  cv::glob(image_path + "/" + "*.png", fnImg, false);
  ROS_WARN("Read images");
  cv::glob(pcd_path + "/" + "*.pcd", fnPcd, false);
  ROS_WARN("Read pcds");
